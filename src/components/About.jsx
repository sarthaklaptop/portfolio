  ...
  return (
    <>
      ...
      className='mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]'>
        ...
        and Three.js. I am a quick learner and collaborate closely
        with clients to create effecient, scalable and user-friendly
        solutions that solve real-world proublems. Let's work together
