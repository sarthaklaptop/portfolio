...
const ProjectCard = ({index, name, description, image, tags, 
  source_code_link}) => {
    return (
      <motion.div variants={fadeIn('up', 'spring', index*0.5, 0.75)}>
        ...
        >
          <div className='relative w-full h-[230px]'>
            ...
            <div className='absolute justify-end inset-0 flex m-3 
            card-img_hover'>
    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          ...
          complex proublems, work with different technologies, and manage projects effectively.
        </motion.p>
      </div>
